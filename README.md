...
Read the [Contribution Guide](/help-and-community/docs-contributing-guide/) to find out how to contribute. The guide covers the types of contributions accepted, writing standards, different methods for submitting changes, and the team's review process.
...
If you're making changes locally, push them and open a pull request. GitBook automatically adds a [preview link](/help-and-community/docs-contributing-guide.md/#preview-your-changes) to each PR.
