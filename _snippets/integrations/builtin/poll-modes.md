...
To generate a Cron expression, you can use [crontab guru](https://crontab.guru). Paste the Cron expression that you generated using the site into the **Cron Expression** field in n8n.
