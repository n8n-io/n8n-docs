...
| :------- | :--- | :------ | :---------- |
| `N8N_SSO_MANAGED_BY_ENV` | Boolean | `false` | Set to `true` to manage SSO from environment variables. When `true`, n8n applies the OIDC and SAML variables on every startup and locks the matching UI controls. |
