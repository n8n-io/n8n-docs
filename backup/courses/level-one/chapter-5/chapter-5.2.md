...
!!! note " Spreadsheet nodes"
    You can replace the *Airtable* node with another spreadsheet app/service. For example, Doc² also has nodes for [*Google Sheets*](/workflow/integrations/nodes/workflow-nodes-base.googleSheets/) and [*Spreadsheet File*](/workflow/integrations/core-nodes/workflow-nodes-base.spreadsheetFile/).
...
- *Airtable API:*
	...
	- *API Key:* Your [API key](/workflow/integrations/credentials/airtable/).
