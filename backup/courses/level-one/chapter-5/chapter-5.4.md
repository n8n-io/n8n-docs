...
For this, you need to use the [**Set node**](/workflow/integrations/core-nodes/n8n-nodes-base.set/), which allows you to select and set the data you want to be transferred from one app/service to another.
