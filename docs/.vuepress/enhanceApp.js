...
export default ({ router, siteData }) => {
	...
	const redirectPaths = {
		...
		'#/quick-start?id=quick-start' : 'getting-started/installation.html',
		'#/quick-start?id=give-n8n-a-spin' : 'getting-started/installation.html',
		'#/quick-start?id=start-with-docker' : 'getting-started/installation.html#docker',
		'#/setup' : 'getting-started/installation.html#npm',
		'#/setup?id=installation' : 'getting-started/installation.html#npm',
		'#/setup?id=start' : 'getting-started/installation.html',
		'#/setup?id=n8n-wth-tunnel' : 'getting-started/installation.html#n8n-wth-tunnel',
		'#/docker' : 'reference/docker.html',
		'#/configuration' : 'getting-started/installation/advanced.configuration.html',
		'#/configuration?id=publish' : 'getting-started/installation/advanced/configuration.html#publish',
		'#/configuration?id=base-url' : 'getting-started/installation/advanced/configuration.html#base-url',
		'#/configuration?id=execution-data-manual-runs' : 'getting-started/installation/advanced/configuration.html#execution-data-manual-runs',
		'#/configuration?id=execution-data-errorsuccess' : 'getting-started/installation/advanced/configuration.html#execution-data-error-success',
		'#/configuration?id=execute-in-same-process' : 'getting-started/installation/advanced/configuration.html#execute-in-same-process',
		'#/configuration?id=exclude-nodes' : 'getting-started/installation/advanced/configuration.html#exclude-nodes',
		'#/configuration?id=custom-nodes-location' : 'getting-started/installation/advanced/configuration.html#custom-nodes-location',
		'#/configuration?id=use-built-in-and-external-modules-in-function-nodes' : 'getting-started/installation/advanced/configuration.html#use-built-in-and-external-modules-in-function-nodes',
		'#/configuration?id=ssl' : 'getting-started/installation/advanced/configuration.html#ssl',
		'#/configuration?id=timezone' : 'getting-started/installation/advanced/configuration.html#timezone',
		'#/configuration?id=user-folder' : 'getting-started/installation/advanced./configurationhtml#user-folder',
		'#/configuration?id=webhook-url' : 'getting-started/installation/advanced/configuration.html#webhook-url',
		'#/configuration?id=configuration-via-file' : 'getting-started/installation/advanced/configuration.html#configuration-via-file',
		...
		'#/server-setup' : 'getting-started/installation/advanced/server-setup.html',
		'#/server-setup?id=example-setup-with-docker-compose' : 'getting-started/installation/advanced/server-setup.html#example-setup-with-docker-compose',
		'#/server-setup?id=_1-install-docker' : 'getting-started/installation/advanced/server-setup.html#_1-install-docker',
		'#/server-setup?id=_2-optional-if-it-should-run-as-not-root-user' : 'getting-started/installation/advanced/server-setup.html#_2-optional-if-it-should-run-as-not-root-user',
		'#/server-setup?id=_3-install-docker-compose' : 'getting-started/installation/advanced/server-setup.html#_3-install-docker-compose',
		'#/server-setup?id=_4-setup-dns' : 'getting-started/installation/advanced/server-setup.html#_4-setup-dns',
		'#/server-setup?id=_5-create-docker-compose-file' : 'getting-started/installation/advanced/server-setup.html#_5-create-docker-compose-file',
		'#/server-setup?id=_6-create-env-file' : 'getting-started/installation/advanced/server-setup.html#_6-create-env-file',
		'#/server-setup?id=_7-create-data-folder' : 'getting-started/installation/advanced/server-setup.html#_7-create-data-folder',
		'#/server-setup?id=_8-start-docker-compose-setup' : 'getting-started/installation/advanced/server-setup.html#_8-start-docker-compose-setup',
		'#/server-setup?id=_9-done' : 'getting-started/installation/advanced/server-setup.html#_9-done',
