...
- Document loaders and text splitters: document loaders pull in documents and data, and prepare them for [embedding](/glossary/#ai-embedding){ data-preview }. Document loaders can use text splitters to break documents into chunks.
