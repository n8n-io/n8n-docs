...
- It’s not scoped to each MCP client. All MCP clients you connect (for example, Claude Desktop and ChatGPT) can see all workflows you’ve enabled for MCP access. You can’t restrict specific workflows to specific clients.
