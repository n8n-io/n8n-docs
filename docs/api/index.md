...
Using n8n's public [API](/glossary/#api){ data-preview }, you can programmatically perform many of the same tasks as you can in the GUI. This section introduces n8n's REST API, including:
