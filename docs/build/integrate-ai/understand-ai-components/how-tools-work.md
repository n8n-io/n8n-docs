...
* [MCP servers](/integrations/mcp-servers.md): connect a registry MCP server from the node panel, or use the [MCP Client Tool](/integrations/builtin/cluster-nodes/sub-nodes/n8n-nodes-langchain.toolmcp.md) for any other MCP endpoint.
