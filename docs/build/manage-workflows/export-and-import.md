...
To select all nodes or a group of nodes, click and drag:
  ![Select a group of nodes](../.gitbook/assets/selectingnodes.gif)

## From the Editor UI menu <a href="#from-the-editor-ui-menu" id="from-the-editor-ui-menu"></a>

From the top navigation bar, select the three dots in the upper right <img src="../.gitbook/assets/three-dots-horizontal.png" alt="Workflow menu icon" data-size="line"> to see the following options: 
