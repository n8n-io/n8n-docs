...
1. Open the workflow.
1. Select **Workflow history** <img src="../.gitbook/assets/workflow-history.png" alt="Workflow history icon" data-size="line">. n8n opens a menu showing the saved workflow versions, and a canvas with a preview of the selected version.
...
1. On the version you want to restore or copy, select **Options** <img src="../.gitbook/assets/three-dot-options-menu.png" alt="Options icon" data-size="line">.
