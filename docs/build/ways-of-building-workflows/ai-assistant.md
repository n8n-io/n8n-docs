...
- **Connect MCP servers:** connect a server from the [MCP servers](https://app.gitbook.com/s/BKcbOzIWja8NfqKDcqHc/build/integrate-ai/mcp-servers) registry directly to the assistant, both to perform tasks and to gather context while it builds workflows for you.
