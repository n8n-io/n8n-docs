...
- **Connect MCP servers:** connect a server from the [MCP servers](../../integrations/mcp-servers.md) registry directly to the assistant, both to perform tasks and to gather context while it builds workflows for you.
