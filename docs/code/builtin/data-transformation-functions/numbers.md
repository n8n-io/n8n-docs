...
A reference document listing built-in convenience functions to support data transformation in [expressions](/glossary/#expression-n8n){ data-preview } for numbers.
