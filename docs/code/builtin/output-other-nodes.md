...
=== "JavaScript"
	...
	| `$("<node-name>").item` | The linked item. This is the item in the specified node used to produce the current item. Refer to [Item linking](/data/referencing-data/item-linking.md) for more information on item linking. | :white_check_mark: |
...
=== "Python"
	...
	| `_("<node-name>").item` | The linked item. This is the item in the specified node used to produce the current item. Refer to [Item linking](/data/referencing-data/item-linking.md) for more information on item linking. | :white_check_mark: |
