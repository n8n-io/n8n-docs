...
- Static data isn't available when testing workflows. The workflow must be active and called by a [trigger](/glossary/#trigger-node-n8n){ data-preview } or webhook to save static data.
