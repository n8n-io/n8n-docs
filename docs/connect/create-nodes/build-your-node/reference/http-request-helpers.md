...
# HTTP request helper for node builders <a href="#http-request-helper-for-node-builders" id="http-request-helper-for-node-builders"></a>
...
Removed from n8n version 1.

[See release notes](https://app.gitbook.com/s/hhM8Cox90Piiv0u0EgHM/release-notes)
{% endhint %}

The previous helper implementation used and exposed the `request-promise` library using `this.helpers.request(options)`.
...
## Migration guide to the new helper <a href="#migration-guide-to-the-new-helper" id="migration-guide-to-the-new-helper"></a>
