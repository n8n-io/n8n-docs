...
# UX guidelines for community nodes <a href="#ux-guidelines-for-community-nodes" id="ux-guidelines-for-community-nodes"></a>
...
## Node structure <a href="#node-structure" id="node-structure"></a>

### Operations to include <a href="#operations-to-include" id="operations-to-include"></a>
...
### Consistency with other nodes <a href="#consistency-with-other-nodes" id="consistency-with-other-nodes"></a>
...
## Node functionality <a href="#node-functionality" id="node-functionality"></a>

### Deleting operations output <a href="#deleting-operations-output" id="deleting-operations-output"></a>
...
### Simplifying output fields <a href="#simplifying-output-fields" id="simplifying-output-fields"></a>

#### Normal nodes: 'Simplify' parameter <a href="#normal-nodes-simplify-parameter" id="normal-nodes-simplify-parameter"></a>
...
#### AI tool nodes: ‘Output’ parameter <a href="#ai-tool-nodes-output-parameter" id="ai-tool-nodes-output-parameter"></a>
...
### Text Case <a href="#text-case" id="text-case"></a>
...
### Operations name, action, and description <a href="#operations-name-action-and-description" id="operations-name-action-and-description"></a>
...
#### Naming `name` <a href="#naming-name" id="naming-name"></a>
...
#### Naming `action` <a href="#naming-action" id="naming-action"></a>
...
#### Naming `description` <a href="#naming-description" id="naming-description"></a>
...
### Referring to parameter and field name <a href="#referring-to-parameter-and-field-name" id="referring-to-parameter-and-field-name"></a>
...
### Boolean description <a href="#boolean-description" id="boolean-description"></a>

Start the description of boolean components with 'Whether...'

## Errors <a href="#errors" id="errors"></a>

### General philosophy <a href="#general-philosophy" id="general-philosophy"></a>
...
### Error structure in the Output panel <a href="#error-structure-in-the-output-panel" id="error-structure-in-the-output-panel"></a>

#### Error Message - What happened <a href="#error-message-what-happened" id="error-message-what-happened"></a>
...
#### Error Description - How to solve or get unstuck <a href="#error-description-how-to-solve-or-get-unstuck" id="error-description-how-to-solve-or-get-unstuck"></a>
