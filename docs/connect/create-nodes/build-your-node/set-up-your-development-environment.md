...
* Node.js and npm. Minimum version Node 22.22.0. You can find [instructions on how to install both using nvm](https://github.com/nvm-sh/nvm) (Node Version Manager) for Linux, Mac, and WSL (Windows Subsystem for Linux). For Windows users, refer to Microsoft's guide to [Install NodeJS on Windows](https://docs.microsoft.com/en-us/windows/dev-environment/javascript/nodejs-on-windows).
