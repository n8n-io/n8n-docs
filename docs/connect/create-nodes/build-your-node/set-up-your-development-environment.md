...
* The [`n8n-node` tool](using-the-n8n-node-tool.md). Use it to create, build, and test your node. It includes n8n for local development, so you don't need to install n8n separately. Refer to [Run your node locally](../test-your-node/run-your-node-locally.md) to test your node. When [building verified community nodes](https://app.gitbook.com/s/BKcbOzIWja8NfqKDcqHc/community-nodes/building-community-nodes), you must use `n8n-node`.
