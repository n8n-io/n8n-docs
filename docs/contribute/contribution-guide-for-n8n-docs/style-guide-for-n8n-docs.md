...
convenience. The authoritative list is `SPACE_INDEX.md` in the repository root, generated daily
from each space's GitBook Git Sync settings and checked against this table in CI. If the two
ever disagree, the generated file is right.
