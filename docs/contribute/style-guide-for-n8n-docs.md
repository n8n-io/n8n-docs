...
* **Tiers:** list low to high, comma-separated, no "and" (unless inline prose rather than bullet point). Cloud order: Starter, Pro, Enterprise. Self-hosted order: Community, Registered Community, Business, Enterprise. Use the exact capitalized names, and spell out "Registered Community" in full.
