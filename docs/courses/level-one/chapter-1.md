...
- **Insights**: Provides analytics and monitoring information for your workflows.  
- **Help**: Contains resources around n8n product and community.  
- **What’s New**: (When updates are available) Indicator for any recent product updates.  
- **Profile menu** (bottom left, next to your username):  
  - **Settings**: Manage users and access settings for a variety of features.  
  - **Sign out**: Log out of your n8n instance.  
