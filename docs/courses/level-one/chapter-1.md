...
- <span class="inline-image">![Home icon](/_images/common-icons/home.png)</span> **Home**: Contains all the workflows and credentials you have access to. During this course, create new workflows here.
