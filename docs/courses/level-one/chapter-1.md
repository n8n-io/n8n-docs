...
First of all, you need to get n8n. There are different [ways to set up n8n](https://docs.n8n.io/getting-started/installation/), choose the option that best suits your skills and needs.
