...
In this lesson, you will build a small [workflow](/glossary.md#workflow-n8n){ data-preview } that gets 10 articles about automation from Hacker News. The workflow consists of five steps:
...
Open the nodes panel (reminder: you can open this by selecting the **+** icon in the top right corner of the [canvas](/glossary.md#canvas-n8n){ data-preview } or selecting Tab on your keyboard).
...
In a real-world scenario, you would likely want to set up a schedule or some other [trigger](/glossary.md#trigger-node-n8n){ data-preview } to run the workflow.
///
