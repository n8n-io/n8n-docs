...
In this lesson, you will build a small [workflow](/glossary.md#workflow-n8n) that gets 10 articles about automation from Hacker News. The workflow consists of five steps:
