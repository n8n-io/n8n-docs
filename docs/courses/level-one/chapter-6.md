...
In this chapter you will learn how to export and import workflows, as well as share your workflows on the [n8n workflows](https://n8n.io/workflows){:target="_blank"} page.
...
* From the command line:
    * Export: See the [full list of commands ](/reference/cli-commands/){:target="_blank"} for exporting workflows or credentials.
    * Import: See the [full list of commands ](/reference/cli-commands/#import-workflows-and-credentials){:target="_blank"} for importing workflows or credentials.

## Sharing workflows

We love to see what users build with n8n and discover inspiring workflows while also sharing our ideas with them! On the [n8n workflows page](https://n8n.io/workflows){:target="_blank"} you can find hundreds of workflows contributed by our team or community of users. Feel free to share your workflows too!
...
1. Sign in to[ n8n.io](https://n8n.io/login){:target="_blank"}.
...
4. In the **_Description_** field, add a screenshot of your workflow and write a description below it.
	...
	* The description should list all the nodes used in the workflow and the function they serve. You should also mention any prerequisites for building the workflow.
    ...
    !!! tip  Workflow description template
        [This is an example](https://n8n.io/workflows/1110){:target="_blank"} of a well-written description that you can use as a template for your own workflows.
