...
Just like you can use [expressions](/code/expressions/index.md) to reference data from other nodes, you can also use some [methods and variables](/code/builtin/index.md) in the **Code node**.
...
- Use n8n's [data transformation nodes](/data/transforming-data.md). Use these nodes to modify the structure of incoming data that contain lists (arrays) without needing to use JavaScript code in the **Code node**:
