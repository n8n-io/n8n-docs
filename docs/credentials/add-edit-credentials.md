...
2. If your n8n instance supports [projects](/glossary/#project-n8n){ data-preview }, you'll also need to choose whether to create the credential inside your personal space or a specific project you have access to. If you're using the community version, you'll create the credential inside your personal space.
...
You can use [expressions](/glossary/#expression-n8n){ data-preview } to set credentials dynamically as your workflow runs:
