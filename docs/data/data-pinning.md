...
When data pinning is active, a banner appears at the top of the node's output panel indicating that the current data is pinned. To unpin data and fetch fresh data on the next execution, select the **Unpin** link in the banner.
