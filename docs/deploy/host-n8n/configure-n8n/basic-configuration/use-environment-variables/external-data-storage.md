...
description: >-
  Environment variables to configure external data storage for your self-hosted
  n8n instance.
...
You need an [Enterprise license key](../../manage-your-license.md) to store execution data or binary data in Azure Blob Storage.
{% endhint %}
