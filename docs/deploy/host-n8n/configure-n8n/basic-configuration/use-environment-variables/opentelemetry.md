...
| `N8N_OTEL_EXPORTER_OTLP_PROTOCOL` | String | `http/protobuf` | OTLP transport for exporting traces. Valid values: `http/protobuf` and `grpc`. The name and values mirror the upstream [`OTEL_EXPORTER_OTLP_PROTOCOL`](https://opentelemetry.io/docs/specs/otel/protocol/exporter/) specification. Refer to [Choose the OTLP protocol](../../../keep-n8n-running/trace-executions-with-opentelemetry.md#choose-the-otlp-protocol) for guidance. | 2.37.0 |
