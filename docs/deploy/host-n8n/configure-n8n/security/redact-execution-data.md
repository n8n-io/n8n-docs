...
When [instance-level enforcement](redact-execution-data.md#instance-level-enforcement) is active, n8n locks the settings covered by the enforced scope to **Redact**. You can't turn them off at the workflow level.
{% endhint %}
