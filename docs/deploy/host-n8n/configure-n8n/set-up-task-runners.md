...
Internal mode is deprecated and will be removed in a future version. Move to [external mode](set-up-task-runners.md#external-mode) for more secure isolation and scaling.
