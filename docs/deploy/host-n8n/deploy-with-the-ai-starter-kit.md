...
description: >-
  Use n8n's curated self-hosted AI Starter Kit to get a list of AI elements to
  quickly start building AI workflows.
contentType: howto
...
# Self-hosted AI Starter Kit <a href="#self-hosted-ai-starter-kit" id="self-hosted-ai-starter-kit"></a>
