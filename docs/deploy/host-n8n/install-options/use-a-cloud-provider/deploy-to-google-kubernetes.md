...
# Hosting n8n on Google Kubernetes Engine <a href="#hosting-n8n-on-google-kubernetes-engine" id="hosting-n8n-on-google-kubernetes-engine"></a>
...
This guide uses the Google Kubernetes Engine (GKE) as the hosting option. If you want to use Cloud Run, refer to [these instructions](deploy-to-google-cloud-run.md).
...
* If you want to persist [manual n8n encryption keys](../../configure-n8n/basic-configuration/use-environment-variables/deployment.md) between restarts. This saves a file containing the key into file storage during startup.
...
{% include "https://app.gitbook.com/s/GixZThfitWP21x2gQFpD/~/reusable/ayueH50ylKcskQmzIsMy/" %}
