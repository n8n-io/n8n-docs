...
You find a example of the BOD mapping file on this page: [How to create a BOD mapping file](https://docs.cloudintegration.eu/docs/doc2app/export/infor/how-to-create-a-bod-mapping-file/)
