...
Extractable columns need to be created first. You will learn here how that works: [Add new table column](https://docs.cloudintegration.eu/docs/doc2app/table-train/training-of-table-extraction/add-new-table-column/)
