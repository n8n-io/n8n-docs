...
If you have completed all your settings and you wish to save them, please confirm this with the `SAVE SETTINGS` button, otherwise the settings will not be applied.
