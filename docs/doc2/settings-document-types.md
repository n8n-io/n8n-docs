...
Here you can set the sensitivity of the MATCH SCORE function for all fields. This value determines when a field is marked in red if DOC² has not extracted the field with 100% probability. In this case the field needs to be validated manually.
