...
For more detailed information please refer to the following documentation: [Master data validation](https://docs.cloudintegration.eu/docs/doc2app/document-validation/master-data-validation/)
