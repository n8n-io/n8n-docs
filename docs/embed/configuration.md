...
n8n has many [environment variables](/hosting/configuration/environment-variables/overview.md) you can configure. Here are the most relevant environment variables for your hosted solution:
