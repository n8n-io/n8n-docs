...
* Each node where the user’s credentials are needed should use an [expression](/code/expressions/index.md) so that the node’s credential field reads the credential provided in the webhook call.
