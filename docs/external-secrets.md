...
For example, you have two n8n instances, one for development and one for production. You use AWS for your vault. In AWS, create a project with two environments, development and production. Generate a token for each AWS environment. Use the token for the development environment to connect your development n8n instance, and the token for your production environment to connect your production n8n instance.
