...
Prefer to self-host? Run `curl -fsSL https://get.n8n.io | sh` to get n8n running locally in one step (see the [one-line setup guide](/deploy/host-n8n/install-options/one-line-setup.md)), then come back and follow the steps below at `http://localhost:5678` instead of your Cloud instance.
