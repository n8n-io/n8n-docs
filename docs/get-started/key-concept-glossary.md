...
Embeddings are numerical representations of data using vectors. They're used by AI to interpret complex data and relationships by mapping values across a high-dimensional space. Vector databases, or vector stores, are databases designed to store and access embeddings.
...
A plan is a commercial subscription tier: Starter, Pro, or Enterprise on n8n Cloud; Business or Enterprise if you self-host. Your plan sets the features, usage limits, and price for your subscription, whether you use n8n Cloud or self-host. See also [edition](#edition-n8n) and [license](#license-n8n).
