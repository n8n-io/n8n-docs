...
You can change n8n's settings using environment variables. For a full list of available configurations see [Environment Variables](/hosting/configuration/environment-variables/overview.md).
...
You can't always work out the correct JSON from the [Environment variables reference](/hosting/configuration/environment-variables/overview.md). For example, to set `N8N_METRICS` to `true`, you need to do:
...
Refer to [Environment variables](/hosting/configuration/environment-variables/overview.md) for details on each variable.
