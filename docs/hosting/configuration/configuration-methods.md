...
While most environment variables can use the `_FILE` suffix, it's more beneficial for sensitive data such as [credentials](/glossary.md#credential-n8n){ data-preview } and database configuration. Here are some examples: 
