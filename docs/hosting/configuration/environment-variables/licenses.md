...
| `N8N_LICENSE_AUTO_RENEW_ENABLED` | Boolean | `true` | Enables (true) or disables (false) autorenewal for licenses.<br>Failure to renew the license will disable Enterprise features.<br>If disabled, the license will need to be manually renewed every 10 days by navigating to Usage and Plan page and pressing F5. |
