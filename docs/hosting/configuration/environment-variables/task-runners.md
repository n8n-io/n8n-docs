...
| `N8N_RUNNERS_ALLOW_PROTOTYPE_MUTATION` | Boolean | `false` | Whether to allow prototype mutation for external libraries. Set to `false` to allow modules that rely on runtime prototype mutation, e.g. `puppeteer`, at the cost of security. | 
