...
If you store binary data in S3 and was later switch to filesystem mode, the instance will continue to read any data that was stored in S3, if `s3` remains listed in `N8N_AVAILABLE_BINARY_DATA_MODES` and if your S3 credentials remain valid.
