...
The Doc² desktop app is the fastest way to try Doc² on Windows or Mac computers (support for Linux is coming soon). Download the app from the link below:
