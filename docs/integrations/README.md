...
n8n also includes a registry of MCP servers you can connect to an agent directly from the node panel in one click. Refer to [MCP servers](mcp-servers.md) for more information.
