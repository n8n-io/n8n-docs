...
!!! note "Credentials"
	Refer to the [Airtable credentials](https://docs.n8n.io/integrations/builtin/credentials/agilecrm/){:target="_blank" .external-link} for guidance on setting up authentication. 
