...
The Automizy node allows you to automate work in the Automizy platform and integrate Automizy with other applications. n8n has built-in support for a wide range of Automizy features, including like creating, reading, listing, updating, deleting contacts, and lists
