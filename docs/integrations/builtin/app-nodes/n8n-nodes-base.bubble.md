...
The Bubble node allows you to automate work in the Bubble platform and integrate Bubble with other applications. n8n has built-in support for a wide range of Bubble features, including creating, deleting, getting, and updating objects.
