...
!!! note "Credentials"
    Refer to the [Cockpit   credentials](https://docs.n8n.io/integrations/builtin/credentials/cockpit/){:target="_blank" .external-link} for guidance on setting up authentication. 
