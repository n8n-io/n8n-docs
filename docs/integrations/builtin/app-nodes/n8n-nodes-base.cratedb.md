...
!!! note "Credentials"
    Refer to the [CrateDB      credentials](https://docs.n8n.io/integrations/builtin/credentials/cratedb/){:target="_blank" .external-link} for guidance on setting up authentication. 
