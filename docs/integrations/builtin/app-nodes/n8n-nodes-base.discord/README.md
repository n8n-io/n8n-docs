...
description: >-
  Learn how to use the Discord node in n8n. Follow technical documentation to
  integrate Discord node into your workflows.
contentType:
  - integration
  - reference
priority: high
...
# Discord node <a href="#discord-node" id="discord-node"></a>
