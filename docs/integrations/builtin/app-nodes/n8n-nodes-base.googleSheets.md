...
![A workflow with the Google Sheets node](/_images/integrations/builtin/app-nodes/googlesheets/workflow.png)
...
![Using the Set node to set data to be inserted in the Google Sheets node](/_images/integrations/builtin/app-nodes/googlesheets/set_node.png)
...
![Using the Google Sheets node to insert data into a Google Sheets spreadsheet](/_images/integrations/builtin/app-nodes/googlesheets/googlesheets_node.png)
...
![Using the Google Sheets node to lookup for data in the Google Sheets spreadsheet](/_images/integrations/builtin/app-nodes/googlesheets/googlesheets1_node.png)
...
![Using the Set node to increase the rent](/_images/integrations/builtin/app-nodes/googlesheets/set1_node.png)
...
![Using the Google Sheets node to update the data to the Google Sheets spreadsheet](/_images/integrations/builtin/app-nodes/googlesheets/googlesheets2_node.png)
...
![Using the Google Sheets node to read data from the Google Sheets spreadsheet](/_images/integrations/builtin/app-nodes/googlesheets/googlesheets3_node.png)
