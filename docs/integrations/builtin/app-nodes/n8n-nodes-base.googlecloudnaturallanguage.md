...
The Google Cloud Natural Language node allows you to automate work in the Google Cloud Natural Language platform and integrate Google Cloud Natural Language with other applications. n8n has built-in support for a wide range of Google Cloud Natural Language features, including analyzing documents.
