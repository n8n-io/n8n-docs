...
description: >-
  Learn how to use the Google Cloud Storage node in n8n. Follow technical
  documentation to integrate Google Cloud Storage node into your workflows.
contentType:
  - integration
  - reference
nodeTitle: Google Cloud Storage node documentation
...
# Google Cloud Storage node <a href="#google-cloud-storage-node" id="google-cloud-storage-node"></a>
...
Refer to [Google Cloud Storage credentials](../credentials/google/README.md) for guidance on setting up authentication.
{% endhint %}
