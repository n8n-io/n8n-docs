...
| **Recalculation Interval** | Enter the desired recalculation interval for the spreadsheet functions. This affects how often NOW, TODAY, RAND, and RANDBETWEEN are updated. <br> - **On Change**: Recalculates whenever there is a change in the spreadsheet. <br> - **Minute**: Recalculates every minute. <br> - **Hour**: Recalculates every hour. <br> Refer to [Set a spreadsheet’s location & calculation settings](https://support.google.com/docs/answer/58515){:target=_blank .external-link} for more information about these options.  |
<!-- vale on -->
