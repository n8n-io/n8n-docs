...
description: >-
  Learn how to use the HighLevel node in n8n. Follow technical documentation to
  integrate HighLevel node into your workflows.
contentType:
  - integration
  - reference
nodeTitle: HighLevel node documentation
originalFilePath: integrations/builtin/app-nodes/n8n-nodes-base.highlevel.md
originalUrl: 'https://docs.n8n.io/integrations/builtin/app-nodes/n8n-nodes-base.highlevel'
...
# HighLevel node <a href="#highlevel-node" id="highlevel-node"></a>
...
Refer to [HighLevel credentials](../credentials/highlevel.md) for guidance on setting up authentication.
{% endhint %}
