...
!!! note "Examples and templates"
    For usage examples and templates to help you get started, take a look at n8n's [Humantic AI integrations](https://n8n.io/integrations/humanticai/){:target="_blank" .external-link) list.
