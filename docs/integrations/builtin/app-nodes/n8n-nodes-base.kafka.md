---
title: Kafka node - n8n Documentation
...
![A workflow with the Kafka node](/_images/integrations/builtin/app-nodes/kafka/workflow.png)
...
![Using the Cron node to trigger the workflow every minute](/_images/integrations/builtin/app-nodes/kafka/cron_node.png)
...
![Using the HTTP Request node to get the information about the location of the ISS](/_images/integrations/builtin/app-nodes/kafka/httprequest_node.png)
...
![Using the Set node to set the data](/_images/integrations/builtin/app-nodes/kafka/set_node.png)
...
1. First of all, you'll have to enter credentials for the Kafka node. You can find out how to do that [here](/integrations/builtin/credentials/kafka/).
...
![Using the Kafka node to send the data to a topic](/_images/integrations/builtin/app-nodes/kafka/kafka_node.png)
