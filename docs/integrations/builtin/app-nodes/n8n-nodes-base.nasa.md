...
The NASA node allows you to automate work in NASA, and integrate NASA with other applications. n8n has built-in support for a wide range of NASA features, including getting, retrieving, and looking up earth assets, earth imagery, feeds, and astroid look-ups. 
