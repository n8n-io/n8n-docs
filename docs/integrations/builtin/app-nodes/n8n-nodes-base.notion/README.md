...
description: >-
  Learn how to use the Notion node in n8n. Follow technical documentation to
  integrate Notion node into your workflows.
contentType:
  - integration
  - reference
priority: high
...
# Notion node <a href="#notion-node" id="notion-node"></a>
