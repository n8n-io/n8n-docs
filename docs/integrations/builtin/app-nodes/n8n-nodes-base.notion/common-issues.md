...
description: >-
  Documentation for common issues and questions in the Notion node in n8n, a
...
# Notion node common issues <a href="#notion-node-common-issues" id="notion-node-common-issues"></a>
...
To check for the data before executing the Notion node, use an [If](../../core-nodes/n8n-nodes-base.if.md) node to check whether the field is unset. This allows you to use the [Edit Fields (Set)](../../core-nodes/n8n-nodes-base.set.md) node to conditionally remove the field when it doesn't have a valid value.
