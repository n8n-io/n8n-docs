...
The PagerDuty node allows you to automate work in PagerDuty, and integrate PagerDuty with other applications. n8n has built-in support for a wide range of PagerDuty features, including creating, updating, and getting incidents, log entries, and users. 
