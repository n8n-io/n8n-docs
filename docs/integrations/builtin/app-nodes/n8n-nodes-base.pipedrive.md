...
description: >-
  Learn how to use the Pipedrive node in n8n. Follow technical documentation to
  integrate Pipedrive node into your workflows.
contentType:
  - integration
  - reference
priority: medium
nodeTitle: Pipedrive node documentation
...
# Pipedrive node <a href="#pipedrive-node" id="pipedrive-node"></a>
...
Refer to [Pipedrive credentials](../credentials/pipedrive.md) for guidance on setting up authentication.
{% endhint %}
