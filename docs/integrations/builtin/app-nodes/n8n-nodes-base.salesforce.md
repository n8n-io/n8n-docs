...
The Salesforce node allows you to automate work in Salesforce, and integrate HSalesforceloPSA with other applications. n8n has built-in support for a wide range of Salesforce features, including creating, updating, deleting, and getting accounts, attachements, cases, documents, and leads. 
