...
description: >-
  Learn how to use the Spotify node in n8n. Follow technical documentation to
  integrate Spotify node into your workflows.
contentType:
  - integration
  - reference
priority: medium
...
Refer to [Spotify credentials](../credentials/spotify.md) for guidance on setting up authentication.
{% endhint %}
