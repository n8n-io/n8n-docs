...
n8n provides a trigger node for Telegram. Refer to the [Telegram Trigger node documentation](../../trigger-nodes/n8n-nodes-base.telegramtrigger/README.md) for more information.
