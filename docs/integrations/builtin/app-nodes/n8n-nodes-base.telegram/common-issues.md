...
## Get the Chat ID <a href="#get-the-chat-id" id="get-the-chat-id"></a>
...
## Send more than 30 messages per second <a href="#send-more-than-30-messages-per-second" id="send-more-than-30-messages-per-second"></a>
...
If you're using the node to [send Telegram messages](message-operations.md#send-message), the message automatically gets an n8n attribution appended to the end:
...
Refer to [Send Message additional fields](message-operations.md#send-message-additional-fields) for more information.
