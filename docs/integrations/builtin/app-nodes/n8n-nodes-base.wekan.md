...
description: >-
  Learn how to use the Wekan node in n8n. Follow technical documentation to
  integrate Wekan node into your workflows.
contentType:
  - integration
  - reference
...
Refer to [Wekan credentials](../credentials/wekan.md) for guidance on setting up authentication.
{% endhint %}
