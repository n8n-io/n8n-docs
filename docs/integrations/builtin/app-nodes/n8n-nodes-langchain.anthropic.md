...
description: >-
  Learn how to use the Anthropic node in n8n. Follow technical documentation to
  integrate Anthropic node into your workflows.
contentType:
  - integration
  - reference
nodeTitle: Anthropic node documentation
...
{% hint style="info" %}
On n8n Cloud, you can use the Anthropic node with [Gateway credits](https://app.gitbook.com/s/jm0ZYRpZIPWge2ZSiDYO/use-n8n-cloud/gateway-credits) instead of your own Anthropic API key. Select **Use Gateway credits** in the node's credential field to run the node without a Anthropic account.
{% endhint %}
