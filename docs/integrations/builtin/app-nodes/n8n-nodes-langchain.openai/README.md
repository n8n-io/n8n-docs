...
The OpenAI node replaces the OpenAI Assistant node, available from n8n 1.29.0.

n8n 1.117.0 introduces V2 of this node, adding support for the OpenAI Responses API and removing support for the [Assistants API](https://platform.openai.com/docs/assistants/migration).
