...
{% hint style="info" %}
On n8n Cloud, you can use the OpenAI node with [Gateway credits](https://app.gitbook.com/s/jm0ZYRpZIPWge2ZSiDYO/use-n8n-cloud/gateway-credits) instead of your own OpenAI API key. Select **Use n8n credits** in the node's credential field to run the node without a OpenAI account.
{% endhint %}
