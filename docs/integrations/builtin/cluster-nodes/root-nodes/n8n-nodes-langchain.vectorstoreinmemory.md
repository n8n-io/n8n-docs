...
# Simple Vector Store node <a href="#simple-vector-store-node" id="simple-vector-store-node"></a>
...
You can connect the Simple Vector Store node directly to the [tool](https://app.gitbook.com/s/CxSeOtVxqqhfxMSac0AV/key-concept-glossary#ai-tool) connector of an [AI agent](n8n-nodes-langchain.agent/README.md) to use a vector store as a resource when answering queries.
