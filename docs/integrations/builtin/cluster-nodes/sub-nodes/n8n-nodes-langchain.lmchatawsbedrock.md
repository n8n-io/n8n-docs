...
{% hint style="info" %}
On node versions before 1.2, the dropdown only lists on-demand foundation models. On node version 1.1, use the **Model Source** parameter to switch it to inference profiles.
{% endhint %}
