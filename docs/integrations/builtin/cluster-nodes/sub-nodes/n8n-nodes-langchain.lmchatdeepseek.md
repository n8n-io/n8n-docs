...
description: >-
  Learn how to use the DeepSeek Chat Model node in n8n. Follow technical
  documentation to integrate DeepSeek Chat Model node into your workflows.
contentType:
  - integration
  - reference
priority: high
...
Use the DeepSeek Chat Model node to use DeepSeek's chat models with conversational [agents](https://app.gitbook.com/s/CxSeOtVxqqhfxMSac0AV/key-concept-glossary#ai-agent).
...
You can find authentication information for this node [here](../../credentials/deepseek.md).
{% endhint %}
