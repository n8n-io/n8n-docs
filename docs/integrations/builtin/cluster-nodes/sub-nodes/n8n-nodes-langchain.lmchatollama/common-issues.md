...
The Ollama Chat Model node is a [sub-node](/glossary.md#sub-node-n8n){ data-preview }. Sub-nodes behave differently than other nodes when processing multiple items using expressions.
