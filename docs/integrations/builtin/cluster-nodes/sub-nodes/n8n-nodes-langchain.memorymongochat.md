...
Use the MongoDB Chat Memory node to use MongoDB as a [memory](https://app.gitbook.com/s/CxSeOtVxqqhfxMSac0AV/key-concept-glossary#ai-memory) server for storing chat history.
