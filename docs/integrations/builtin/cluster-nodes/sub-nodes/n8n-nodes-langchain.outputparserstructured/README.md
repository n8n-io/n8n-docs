...
description: >-
  Learn how to use the Structured Output Parser node in n8n. Follow technical
  documentation to integrate Structured Output Parser node into your workflows.
contentType:
  - integration
  - reference
priority: high
...
# Structured Output Parser node <a href="#structured-output-parser-node" id="structured-output-parser-node"></a>
