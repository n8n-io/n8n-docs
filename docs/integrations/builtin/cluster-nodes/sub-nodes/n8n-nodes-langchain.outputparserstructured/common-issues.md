...
The Structured Output Parser node is a [sub-node](/glossary/#sub-node-n8n){ data-preview }. Sub-nodes behave differently than other nodes when processing multiple items using expressions.
