...
The Contextual Compression Retriever node improves the answers returned from [vector store](/glossary.md#ai-vector-store){ data-preview } document similarity searches by taking into account the context from the query.
