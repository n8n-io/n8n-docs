...
description: >-
  Learn how to use the Vector Store Retriever node in n8n. Follow technical
  documentation to integrate Vector Store Retriever node into your workflows.
contentType:
  - integration
  - reference
priority: medium
nodeTitle: Vector Store Retriever node documentation
originalFilePath: >-
