...
description: >-
  Learn how to use the Workflow Retriever node in n8n. Follow technical
  documentation to integrate Workflow Retriever node into your workflows.
contentType:
  - integration
  - reference
priority: medium
...
* **Parameter** and copy in a complete [workflow JSON](https://app.gitbook.com/s/rPN1zU5jaYNvwH7RzxqA/manage-workflows/export-and-import).

### Workflow values <a href="#workflow-values" id="workflow-values"></a>

{% include "https://app.gitbook.com/s/GixZThfitWP21x2gQFpD/~/reusable/SS2AYw02q4Smbaiengtc/" %}
