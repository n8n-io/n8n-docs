...
The Calculator node is a [tool](/glossary.md#ai-tool){ data-preview } that allows an [agent](/glossary.md#ai-agent){ data-preview } to run mathematical calculations.
