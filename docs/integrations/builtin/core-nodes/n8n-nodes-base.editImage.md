...
![A workflow with the Edit Image node](/_images/integrations/builtin/core-nodes/editimage/workflow.png)
...
![Using the HTTP Request node to get an image](/_images/integrations/builtin/core-nodes/editimage/httprequest_node.png)
...
![Using the Edit Image node to add text to an image](/_images/integrations/builtin/core-nodes/editimage/editimage_node.png)
