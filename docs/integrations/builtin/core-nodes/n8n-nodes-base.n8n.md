...
Refer to the [API authentication documentation](https://app.gitbook.com/s/r7wKI4I1BgdBCuq5Cvcx/n8n-api/authentication) for authentication information for this node.
{% endhint %}
