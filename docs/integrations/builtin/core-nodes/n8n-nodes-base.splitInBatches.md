...
![Using the Split In Batches node to split the data](/_images/integrations/builtin/core-nodes/splitinbatches/splitinbatches_node.png)
...
![Using the RSS Read node to read data from RSS feed](/_images/integrations/builtin/core-nodes/splitinbatches/rssfeedread_node.png)
