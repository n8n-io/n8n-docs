...
![A workflow with the Switch node](/_images/integrations/builtin/core-nodes/switch/workflow.png)
...
![Using the Switch node to conditionally execute based on the input](/_images/integrations/builtin/core-nodes/switch/switch_node.png)
...
![Using the Set node to set value for route 1](/_images/integrations/builtin/core-nodes/switch/set_node.png)
...
![Using the Set node to set value for route 1](/_images/integrations/builtin/core-nodes/switch/set1_node.png)
...
![Using the Set node to set value for route 2](/_images/integrations/builtin/core-nodes/switch/set2_node.png)
