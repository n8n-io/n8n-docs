...
If so, set the `N8N_PROXY_HOPS` [environment variable](/hosting/configuration/environment-variables/overview.md) to the number of reverse-proxies n8n is running behind.
