...
- The **Environment**:
    - Choose **Cloud-hosted** if you don't self-host Bitwarden. Select the suitable **Server Geographies**. Refer to the [Bitwarden Server Geographies documentation](https://bitwarden.com/help/server-geographies/) for more information about server geographies.
