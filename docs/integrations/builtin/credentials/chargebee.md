...
- An **Account Name**: This is your Chargebee Site Name or subdomain, for example if we're using `https://n8n.chargebee.com`, the Account Name would be `n8n`.
...
Refer to their more general [API authentication documentation](https://apidocs.chargebee.com/docs/api/auth?lang=curl){:target=_blank .external-link} for any further clarification.
