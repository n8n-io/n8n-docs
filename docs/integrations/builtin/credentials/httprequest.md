...
* _Optional:_ A **Documentation URL**: The provider page where you create or copy the secret. It doesn't appear in the credential form; n8n Assistant uses it to point you to the exact page.
