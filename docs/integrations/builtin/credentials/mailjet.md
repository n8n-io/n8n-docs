...
Refer to [Mailjet's Email API documentation](https://dev.mailjet.com/email/guides/) and [Mailjet's SMS API documentation](https://github.com/mailjet/api-documentation/blob/master/guides-sms/_send-sms-api.md) for more information about each service.
