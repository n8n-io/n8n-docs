...
The Microsoft Excel (OneDrive), Microsoft Outlook, and Microsoft Teams nodes support this credential from node version 2. The Microsoft Excel (SharePoint) node supports it from node version 1. n8n plans to support the Microsoft SharePoint node.
{% endhint %}
