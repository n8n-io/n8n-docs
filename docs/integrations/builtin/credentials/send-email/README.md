...
description: >-
  Documentation for Send Email credentials. Use these credentials to
  authenticate Send Email in n8n, a workflow automation platform.
contentType:
  - integration
  - reference
priority: high
...
# Send Email credentials <a href="#send-email-credentials" id="send-email-credentials"></a>
