...
description: >-
  Learn how to use the ActiveCampaign Trigger node in n8n. Follow technical
  documentation to integrate ActiveCampaign Trigger node into your workflows.
contentType:
  - integration
  - reference
priority: medium
...
# ActiveCampaign Trigger node <a href="#activecampaign-trigger-node" id="activecampaign-trigger-node"></a>
