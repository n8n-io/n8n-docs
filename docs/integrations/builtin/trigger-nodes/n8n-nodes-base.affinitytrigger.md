...
description: >-
  Learn how to use the Affinity Trigger node in n8n. Follow technical
  documentation to integrate Affinity Trigger node into your workflows.
contentType:
  - integration
  - reference
...
# Affinity Trigger node <a href="#affinity-trigger-node" id="affinity-trigger-node"></a>
