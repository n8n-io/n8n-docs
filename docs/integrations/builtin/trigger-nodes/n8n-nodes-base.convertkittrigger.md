...
description: >-
  Learn how to use the ConvertKit Trigger node in n8n. Follow technical
  documentation to integrate ConvertKit Trigger node into your workflows.
contentType:
  - integration
  - reference
...
# ConvertKit Trigger node <a href="#convertkit-trigger-node" id="convertkit-trigger-node"></a>
...
Refer to the [ConvertKit credentials documentation](../credentials/convertkit.md) for authentication information for this node.
{% endhint %}
...
n8n provides an app node for ConvertKit. Refer to the [ConvertKit node documentation](../app-nodes/n8n-nodes-base.convertkit.md) for more information.
