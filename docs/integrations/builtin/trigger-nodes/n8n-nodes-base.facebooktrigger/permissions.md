...
description: >-
  ...
  Permissions object into your workflows.
contentType:
  - integration
  - reference
priority: medium
nodeTitle: Facebook Trigger Permissions object documentation
originalFilePath: >-
...
# Facebook Trigger Permissions object <a href="#facebook-trigger-permissions-object" id="facebook-trigger-permissions-object"></a>

Use this object to receive updates when a user grants or revokes a permission for your app. Refer to [Facebook Trigger](README.md) for more information on the trigger itself.
