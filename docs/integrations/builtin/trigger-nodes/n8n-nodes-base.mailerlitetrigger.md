...
description: >-
  Learn how to use the MailerLite Trigger node in n8n. Follow technical
  documentation to integrate MailerLite Trigger node into your workflows.
contentType:
  - integration
  - reference
nodeTitle: MailerLite Trigger node documentation
...
# MailerLite Trigger node <a href="#mailerlite-trigger-node" id="mailerlite-trigger-node"></a>
