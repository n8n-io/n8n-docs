...
description: >-
  Learn how to use the Wise Trigger node in n8n. Follow technical documentation
  to integrate Wise Trigger node into your workflows.
contentType:
  - integration
  - reference
...
Refer to the [Wise credentials documentation](../credentials/wise.md) for authentication information for this node.
{% endhint %}
