...
# Install community nodes from npm in the n8n app <a href="#install-community-nodes-from-npm-in-the-n8n-app" id="install-community-nodes-from-npm-in-the-n8n-app"></a>
