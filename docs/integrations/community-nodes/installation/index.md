...
* [From environment variables](/integrations/community-nodes/installation/env-install.md): use this method to bootstrap an instance with a fixed set of community packages, for example through a deployment pipeline.
