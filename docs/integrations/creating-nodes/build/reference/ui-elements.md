...
Users can drag and drop data values to map them to fields. Dragging and dropping creates an [expression](/glossary/#expression-n8n){ data-preview } to load the data value. n8n supports this automatically.
