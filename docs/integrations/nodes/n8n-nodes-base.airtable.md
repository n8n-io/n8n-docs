...
![A workflow with the Airtable node](/_images/integrations/nodes/airtable/workflow.png)
...
![Using the Set node to set data to be inserted by the Airtable node](/_images/integrations/nodes/airtable/set_node.png)
...
![Using the Airtable node to insert data into an Airtable table](/_images/integrations/nodes/airtable/airtable_node.png)
...
![Using the Airtable node to update data of a record](/_images/integrations/nodes/airtable/airtable2_node.png)
