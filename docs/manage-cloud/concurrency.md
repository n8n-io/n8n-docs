...
- [Test evaluations](/glossary/#evaluation-n8n){ data-preview } do not count towards concurrency limits. Your test evaluation concurrency limit is equal to, but separate from, your plan's regular concurrency limit.
