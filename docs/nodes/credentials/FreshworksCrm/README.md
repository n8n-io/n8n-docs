---
permalink: /credentials/freshworksCrm
description: Learn to configure credentials for the Freshworks CRM node in n8n
---

# Freshworks CRM

You can use these credentials to authenticate the following nodes:
- [Freshworks CRM](../../nodes-library/nodes/FreshworksCrm/README.md)
