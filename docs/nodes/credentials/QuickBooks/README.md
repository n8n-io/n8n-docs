---
permalink: /credentials/quickbooks
description: Learn to configure credentials for the QuickBooks node in n8n
---

# QuickBooks

You can use these credentials to authenticate the following nodes with QuickBooks.
- [QuickBooks](../../nodes-library/nodes/QuickBooks/README.md)
