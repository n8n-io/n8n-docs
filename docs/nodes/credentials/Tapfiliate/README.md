---
permalink: /credentials/tapfiliate
description: Learn to configure credentials for the Tapfiliate node in n8n
---

# Tapfiliate

You can use these credentials to authenticate the following nodes with Tapfiliate.
- [Tapfiliate](../../nodes-library/nodes/Tapfiliate/README.md)
