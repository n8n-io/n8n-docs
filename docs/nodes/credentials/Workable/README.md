---
permalink: /credentials/workable
description: Learn to configure credentials for the Workable node in n8n
---

# Workable

You can use these credentials to authenticate the following nodes:
- [Workable Trigger](../../nodes-library/trigger-nodes/WorkableTrigger/README.md)
