...
- **Request Method:** In this dropdown list, there are several methods that can be used to send different type of HTTP requests.
	...
	- POST
	- PUT
- **URL:** This field is where the URL to make the request to has to be entered.
- **Ignore SSL Issues:** This option can be used to download the response even when SSL validation is not possible.
