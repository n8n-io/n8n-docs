---
permalink: /nodes/n8n-nodes-base.googleBigQuery
description: Learn how to use the Google BigQuery node in n8n
---
...
![A workflow with the Google BigQuery node](./workflow.png)
...
1. First of all, you'll have to enter credentials for the Google BigQuery node. You can find out how to do that [here](../../../credentials/Google/README.md).
...
![Using the Google BigQuery node to create new record](./GoogleBigQuery_node.png)
