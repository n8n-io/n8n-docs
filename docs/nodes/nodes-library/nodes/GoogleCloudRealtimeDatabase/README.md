---
permalink: /nodes/n8n-nodes-base.googleFirebaseReatimeDatabase
...
![A workflow with the Google Cloud Realtime Database node](./workflow.png)
...
1. First of all, you'll have to enter credentials for the Google Cloud Realtime Database node. You can find out how to do that [here](../../../credentials/Google/README.md).
...
![Using the Google Cloud Realtime Database node to push the data to a path](./GoogleCloudRealtimeDatabase_node.png)
