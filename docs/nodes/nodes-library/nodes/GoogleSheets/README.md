...
This example workflow uses the Set node to generate data that we want to add to Google Sheets. You can also use other nodes, for example, the [HTTP Request](../../core-nodes/HTTPRequest/README.md) node, to get the data you want to add to the Google Sheets.
::: v-pre
