---
permalink: /nodes/n8n-nodes-base.mqtt
description: Learn how to use the MQTT node in n8n
---
...
![A workflow with the MQTT node](./workflow.png)
...
1. First of all, you'll have to enter credentials for the MQTT node. You can find out how to do that [here](../../../credentials/MQTT/README.md).
...
![Using the MQTT node to send the data to a topic](./MQTT_node.png)
