...
nodeTitle: Sustainable use license
...
# Sustainable Use License <a href="#sustainable-use-license" id="sustainable-use-license"></a>
...
#### Can I use n8n to act as the back-end to power a feature in my app? <a href="#can-i-use-n8n-to-act-as-the-back-end-to-power-a-feature-in-my-app" id="can-i-use-n8n-to-act-as-the-back-end-to-power-a-feature-in-my-app"></a>
...
##### Example 1: Sync ACME app with HubSpot <a href="#example-1-sync-acme-app-with-hubspot" id="example-1-sync-acme-app-with-hubspot"></a>
...
##### Example 2: Embed AI chatbot in ACME app <a href="#example-2-embed-ai-chatbot-in-acme-app" id="example-2-embed-ai-chatbot-in-acme-app"></a>
...
### Why did you switch to the Sustainable Use License from your previous license arrangement (Apache 2.0 with Commons Clause)? <a href="#why-did-you-switch-to-the-sustainable-use-license-from-your-previous-license-arrangement-apache-20-with-commons-clause" id="why-did-you-switch-to-the-sustainable-use-license-from-your-previous-license-arrangement-apache-20-with-commons-clause"></a>
...
### What are the main differences between the Sustainable Use License and your previous license arrangement (Apache 2.0 with Commons Clause)? <a href="#what-are-the-main-differences-between-the-sustainable-use-license-and-your-previous-license-arrangement-apache-20-with-commons-clause" id="what-are-the-main-differences-between-the-sustainable-use-license-and-your-previous-license-arrangement-apache-20-with-commons-clause"></a>
