...
Many of the nodes in n8n require you to have an account with the service for which the node was built.
...
APIs are a critical part of many n8n nodes and workflows. The nodes talk to the API that is provided by a service on the internet and n8n workflows allow these APIs to talk to each other.
...
While n8n is written in TypeScript, the final code generated is JavaScript and the [Function node](https://docs.n8n.io/nodes/n8n-nodes-base.function/) uses JavaScript to create customized nodes.
...
n8n is distributed as an npm package.
