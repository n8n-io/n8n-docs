...
```
## Get number of items returned by a node

Depending on your use-case, you might want to get the number of items returned by a node. Use the following snippet in the Function node.
