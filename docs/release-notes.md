...
This release removes `own` mode, set by the `EXECUTION_PROCESS` environment variable. n8n will not start if this variable is set. Please consider using queue mode if you were using `own` mode.
///
