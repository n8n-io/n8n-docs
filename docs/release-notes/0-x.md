...
When using [expressions](/data/expressions.md), n8n will now offer you suggestions as you type.
...
**core**: Luxon now applies the correct timezone. Refer to [Luxon](/data/specific-data-types/luxon.md) for more information.<br>
