...
The [Item Lists node](/integrations/builtin/core-nodes/n8n-nodes-base.itemlists.md) now supports a Summarize operation. This acts similarly to generating pivot tables in Excel, allowing you to aggregate and compare data.
...
* [Item Lists node](/integrations/builtin/core-nodes/n8n-nodes-base.itemlists.md): add an operation to create arrays from input items.
...
* [Orbit:](/integrations/builtin/app-nodes/n8n-nodes-base.orbit.md) Fixed a bug causing API requests to use an incorrect workspace identifier.
...
* [Item Lists:](/integrations/builtin/core-nodes/n8n-nodes-base.itemlists.md) Fixed an erroneous placeholder text.
...
* [Item Lists](/integrations/builtin/core-nodes/n8n-nodes-base.itemlists.md)
...
* [Orbit:](/integrations/builtin/app-nodes/n8n-nodes-base.orbit.md) Fixed an issue with the activity type in Post operation
...
* [Orbit:](/integrations/builtin/app-nodes/n8n-nodes-base.orbit.md) Fixed issues with the Post resource
