...
With the [**Respond to Chat](/integrations/builtin/core-nodes/n8n-nodes-langchain.chat.md) node**, you can now access Human-in-the-Loop functionality natively in n8n Chat.
