...
This guide shows you how to automate a task using a [workflow](/glossary.md#workflow-n8n){ data-preview } in n8n, explaining key concepts along the way. You will:
...
* Understand key concepts and skills, including:
    ...
    * Configuring [credentials](/glossary.md#credential-n8n){ data-preview }
    * Manipulating data
    * Representing logic in an n8n workflow
    * Using [expressions](/glossary.md#expression-n8n){ data-preview }
