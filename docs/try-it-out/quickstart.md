...
This quickstart gives you a quick taste of n8n. Its aim is to allow you to try out the UI, and introduce you to two key features: workflow templates and [expressions](/glossary/#expression-n8n){ data-preview }. It doesn't include detailed explanations or explore concepts.

You will:

* Load a [workflow](/glossary/#workflow-n8n){ data-preview } from the workflow templates library
...
n8n provides a quickstart [template](/glossary/#template-n8n){ data-preview } using training nodes. This allows you to work with fake data, and avoids setting up [credentials](/glossary/#credential-n8n){ data-preview }.
...
3. Select **Customer Messenger (n8n training)** to add the node to the [canvas](/glossary/#canvas-n8n){ data-preview }. n8n opens the node automatically.
