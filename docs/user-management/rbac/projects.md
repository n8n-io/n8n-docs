...
n8n uses projects to group workflows and [credentials](/glossary/#credential-n8n){ data-preview }, and assigns [roles](/user-management/rbac/role-types.md) to users in each project. This means that a single user can have different roles in different projects, giving them different levels of access.
