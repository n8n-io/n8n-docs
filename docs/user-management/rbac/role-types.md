...
\* Requires **Enable external secrets for project roles** to be turned on by an instance owner or admin. Refer to [Access for project roles](/external-secrets.md#access-for-project-roles).
