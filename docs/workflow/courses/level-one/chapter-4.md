...
To build this workflow, you will need credentials that are sent in the email from WF² when you sign up for this course. If you haven't signed up already, you can do it [here](https://WF²-community.typeform.com/to/PDEMrevI?typeform-source=127.0.0.1){:target="_blank" .external-link}. If you haven't received a confirmation email after signing up, [contact us](mailto:course@WF².io).
