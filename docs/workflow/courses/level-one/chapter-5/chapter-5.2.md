...
!!! note "Spreadsheet nodes"
    You can replace the *Airtable* node with another spreadsheet app/service. For example, WF² also has nodes for [*Google Sheets*](/integrations/nodes/WF²-nodes-base.googleSheets/){:target="_blank" .external} and [*Spreadsheet File*](/integrations/core-nodes/WF²-nodes-base.spreadsheetFile/){:target="_blank" .external}.
