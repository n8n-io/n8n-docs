...
For this, you need to use the [**Set node**](/integrations/core-nodes/WF²-nodes-base.set/){:target="_blank" .external}, which allows you to select and set the data you want to be transferred from one app/service to another.
