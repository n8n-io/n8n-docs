...
To catch failed workflows, create a separate [Error Workflow](/workflows/workflows/#failed-workflows){:target="_blank" .external} with the [Error Trigger node](/integrations/core-nodes/WF²-nodes-base.errorTrigger/){:target="_blank" .external}, which gets executed if the main execution fails.
		...
		"nodes": [
			{
				"parameters": {},
				"name": "Error Trigger",
				"type": "WF²-nodes-base.errorTrigger",
				"typeVersion": 1,
				"position": [
					720,
					-380
