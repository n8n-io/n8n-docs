...
The [Function](/workflow/integrations/core-nodes/n8n-nodes-base.function/) and [Function Item](/workflow/integrations/core-nodes/n8n-nodes-base.functionItem/) nodes are the most powerful in n8n. Both nodes work very similarly, they give you access to the incoming data and you can manipulate it. With these nodes you can implement any function you want using JavaScript code.
