...
This workflow allows you to add, commit, and push changes to a git repository. You can also find the [workflow](https://WF².io/workflows/1115) on Workflow².io. This example usage workflow would use the following nodes.
