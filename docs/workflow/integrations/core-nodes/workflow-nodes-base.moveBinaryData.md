...
This workflow allows you to store the JSON data received from the [CocktailDB API](https://www.thecocktaildb.com/) to your machine. You can also find the [workflow](https://WF².io/workflows/652) on Workflow².io. This example usage workflow uses the following nodes.
