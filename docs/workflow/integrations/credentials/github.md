...
- [GitHub Trigger](/workflow/integrations/trigger-nodes/workflow-nodes-base.githubTrigger/)
...
The following video demonstrates the steps to authenticate the GitHub node on [WF².cloud](https://WF².cloud).
