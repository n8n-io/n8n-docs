...
5. Enter a name for your credentials in the ***Credentials Name*** field in the 'Stackby API' credentials in Workflow².
6. Paste the API key in the ***API Key*** field in the 'Stackby API' credentials in Workflow².
