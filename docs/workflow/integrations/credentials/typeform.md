...
7. Use the displayed ***Client ID*** and ***Client secret*** with your Typeform OAuth2 API credentials in Workflow².
8. Click on the circle button in the OAuth section to connect a Typeform account to Workflow².
...
9. Enter a name for your credentials in the ***Credentials Name*** field in the 'Typeform API' credentials in Workflow².
10. Paste the access token in the ***Access Token*** field in the 'Typeform API' credentials in Workflow².
11. Click the ***Create*** button to save your credentials in Workflow².
