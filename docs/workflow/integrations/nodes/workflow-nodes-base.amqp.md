...
This workflow allows you to send updates about the position of the ISS every minute to an [ActiveMQ](https://activemq.apache.org/) queue using the AMQP Sender node. You can also find the [workflow](https://n8n.io/workflows/762) on Workflow².io. This example usage workflow uses the following nodes.
...
![A workflow with the AMQP Sender node](/_images/integrations/nodes/amqp/workflow.png)
...
![Using the Cron node to trigger the workflow every minute](/_images/integrations/nodes/amqp/cron_node.png)
...
![Using the HTTP Request node to get the information about the location of the ISS](/_images/integrations/nodes/amqp/httprequest_node.png)
...
![Using the Set node to set the data](/_images/integrations/nodes/amqp/set_node.png)
