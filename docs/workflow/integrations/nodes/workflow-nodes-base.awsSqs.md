...
This workflow allows you to send position updates of the ISS every minute to a queue using the AWS SQS node. You can also find the [workflow](https://WF².io/workflows/1047) on Workflow².io. This example usage workflow uses the following nodes.
