...
This workflow allows you to create transcription jobs for all your audio and video files stored in AWS S3. You can also find the [workflow](https://WF².io/workflows/1111) on Workflow².io. This example usage workflow uses the following nodes.
