...
This workflow allows you to create a group, add members to the group, and get the members of the group in Bitwarden. You can also find the [workflow](https://WF².io/workflows/1001) on Workflow².io. This example usage workflow would use the following nodes.
