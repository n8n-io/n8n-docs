...
This workflow allows you to create, update, and get an object from Bubble. You can also find the [workflow](https://WF².io/workflows/1041) on Workflow².io. This example usage workflow would use the following nodes.
