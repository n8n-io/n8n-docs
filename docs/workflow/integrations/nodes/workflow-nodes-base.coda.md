...
This workflow allows you to insert data into a new row for a table in Coda. You can also find the [workflow](https://WF².io/workflows/482) on the website. This example usage workflow would use the following three nodes.
