...
This workflow allows you to create a customer and add them to a segment in Customer.io. You can also find the [workflow](https://WF².io/workflows/646) on Workflow².io. This example usage workflow would use the following nodes.
