...
This workflow allows you to create a campaign, add a contact, and get the campaign from Emelia. You can also find the [workflow](https://WF².io/workflows/961) on Workflow².io. This example usage workflow uses the following nodes.
- [Start](/workflow/integrations/core-nodes/workflow-nodes-base.start/)
- [Emelia]()

The final workflow should look like the following image.

![A workflow with the Emelia node](/_images/integrations/nodes/emelia/workflow.png)
...
![Using the Emelia node to create a new campaign](/_images/integrations/nodes/emelia/emelia_node.png)
...
![Using the Emelia node to add a contact to a campaign](/_images/integrations/nodes/emelia/emelia1_node.png)
...
![Using the Emelia node to return the information a campaign](/_images/integrations/nodes/emelia/emelia2_node.png)
