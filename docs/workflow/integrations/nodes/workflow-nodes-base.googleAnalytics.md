...
This workflow allows you to get analytical metrics of your website using the Goole Analytics node and store it in Airtable. You can also find the [workflow](https://WF².io/workflows/892) on Workflow².io. This example usage workflow uses the following nodes.
