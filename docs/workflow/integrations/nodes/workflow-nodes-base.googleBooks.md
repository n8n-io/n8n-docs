...
This workflow allows you to get a volume and add it to your bookshelf using the Google Books node. You can also find the [workflow](https://WF².io/workflows/771) on Workflow².io. This example usage workflow uses the following nodes.
