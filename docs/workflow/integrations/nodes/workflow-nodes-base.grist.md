...
![A workflow with the Grist node](/_images/integrations/nodes/grist/workflow.png)
...
![Table in an example Grist document](/_images/integrations/nodes/grist/table_start.png)
...
![Using the Grist node to insert data into an Grist table](/_images/integrations/nodes/grist/grist_node.png)

And here's the result of adding the record to the Grist table:

![The example table after creating a new record with the Grist node](/_images/integrations/nodes/grist/table_create.png)
...
![Using the Grist node to read data from an Grist table](/_images/integrations/nodes/grist/grist1_node.png)
...
![Using the Grist node to update data of a record](/_images/integrations/nodes/grist/grist2_node.png)

The result is that the Name in the first record changed from 'Grist' to 'Grist Labs':

![The example table after updating a record with the Grist node](/_images/integrations/nodes/grist/table_update.png)
