...
This workflow allows you to create, update, and get a user from Iterable. You can also find the [workflow](https://n8n.io/workflows/813) on Workflow².io. This example usage workflow would use the following nodes.
