...
This workflow allows you to send updates about the position of the ISS every minute to a topic in Kafka using the Kafka node. You can also find the [workflow](https://WF².io/workflows/750) on Workflow².io. This example usage workflow uses the following nodes.
