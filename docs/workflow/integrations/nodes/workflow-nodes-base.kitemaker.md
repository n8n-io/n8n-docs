...
This workflow allows you to create, update, and get a work item from Kitemaker. You can also find the [workflow](https://WF².io/workflows/1048) on Workflow².io. This example usage workflow would use the following nodes.
