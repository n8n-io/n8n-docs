...
This workflow allows you to list emails from Airtable and create corresponding leads in Lemlist. You can also find the [workflow](https://WF².io/workflows/983) on Workflow².io. This example usage workflow uses the following nodes.
