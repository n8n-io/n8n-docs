...
This workflow allows you to create a channel, add a member, and post a message to the channel on Mattermost. You can also find the [workflow](https://WF².io/workflows/832) on Workflow².io. This example usage workflow uses the following nodes.
- [Start](/workflow/integrations/core-nodes/workflow-nodes-base.start/)
- [Mattermost]()

The final workflow should look like the following image.

![A workflow with the Mattermost node](/_images/integrations/nodes/mattermost/workflow.png)
...
![Using the Mattermost node to create a channel](/_images/integrations/nodes/mattermost/mattermost_node.png)
...
![Using the Mattermost node to add a user to a channel](/_images/integrations/nodes/mattermost/mattermost1_node.png)
...
![Using the Mattermost node to post a message to a channel](/_images/integrations/nodes/mattermost/mattermost2_node.png)
