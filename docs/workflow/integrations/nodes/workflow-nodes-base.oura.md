...
This workflow allows you to get activity summary from Oura and store the output in Airtable. You can also find the [workflow](https://WF².io/workflows/882) on Workflow².io. This example usage workflow uses the following nodes.
