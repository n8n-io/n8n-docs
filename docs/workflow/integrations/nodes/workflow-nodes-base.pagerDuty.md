...
This workflow allows you to create, update, and get an incident on PagerDuty. You can also find the [workflow](https://WF².io/workflows/411) on Workflow².io. This example usage workflow would use the following nodes.
