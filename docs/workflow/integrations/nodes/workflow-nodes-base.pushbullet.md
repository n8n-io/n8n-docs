...
This workflow allows you to send daily weather updates via a push notification using the Pushbullet node. You can also find the [workflow](https://WF².io/workflows/740) on Workflow².io. This example usage workflow uses the following nodes.
