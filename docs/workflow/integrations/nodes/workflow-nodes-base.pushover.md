...
This workflow allows you to send daily weather updates via a push notification using the Pushover node. You can also find the [workflow](https://n8n.io/workflows/740) on Workflow².io. This example usage workflow uses the following nodes.
...
![A workflow with the Pushover node](/_images/integrations/nodes/pushover/workflow.png)
...
![Using the Cron node to trigger the workflow daily at 9 am](/_images/integrations/nodes/pushover/cron_node.png)
...
![Using the OpenWeatherMap node to get weather updates for Berlin](/_images/integrations/nodes/pushover/openweathermap_node.png)
...
![Using the Pushover node to send weather updates via a push notification](/_images/integrations/nodes/pushover/pushover_node.png)
