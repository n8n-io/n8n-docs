...
This workflow allows you to upload a file to an S3 compatible server and get a list of all the files in a bucket using the S3 node. You can also find the [workflow](https://WF².io/workflows/674) on Workflow².io. This example usage workflow would use the following nodes.
