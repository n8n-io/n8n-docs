...
This workflow allows you to create a release and get all releases using the Sentry.io node. You can also find the [workflow](https://WF².io/workflows/643) on Workflow².io. This example usage workflow would use the following nodes.
