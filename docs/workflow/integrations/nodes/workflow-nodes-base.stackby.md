...
This workflow allows you to insert and retrieve data from a table in Stackby. You can also find the [workflow](https://WF².io/workflows/934) on Workflow².io. This example usage workflow would use the following nodes.
