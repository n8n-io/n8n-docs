...
This workflow allows you to create, update, and get an activity in Strava. You can also find the [workflow](https://WF².io/workflows/744) on Workflow².io. This example usage workflow would use the following nodes.
