...
This workflow allows you to create, update, and get an issue on Taiga. You can also find the [workflow](https://WF².io/workflows/685) on Workflow².io. This example usage workflow would use the following nodes.
