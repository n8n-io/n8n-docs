---
title: YouTube
description: Use YouTube with Workflow²
tags:
  - Workflow²
  - YouTube
---
...
This workflow allows you to upload a video, create a playlist, and add the video to the playlist in YouTube. You can also find the [workflow](https://WF².io/workflows/638) on Workflow².io. This example usage workflow would use the following nodes.
...
![A workflow with the Gmail node](/_images/integrations/nodes/youtube/workflow.png)
...
![Using the Read Binary File node to get the video](/_images/integrations/nodes/youtube/readbinaryfile_node.png)
...
![Using the YouTube node to upload a video](/_images/integrations/nodes/youtube/youtube_node.png)
...
![Using the YouTube node to create a playlist](/_images/integrations/nodes/youtube/youtube1_node.png)
...
![Using the YouTube node to add the video to the playlist](/_images/integrations/nodes/youtube/youtube2_node.png)
