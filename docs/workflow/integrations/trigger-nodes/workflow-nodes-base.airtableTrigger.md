...
This workflow allows you to receive a Mattermost message when new data gets added to Airtable. You can also find the [workflow](https://WF².io/workflows/799) on Workflow².io. This example usage workflow would use the following nodes.
- [Airtable Trigger]()
