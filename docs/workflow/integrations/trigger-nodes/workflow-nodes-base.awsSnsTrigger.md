...
This workflow allows you to receive updates for events in AWS SNS. You can also find the [workflow](https://WF².io/workflows/509) on the website. This example usage workflow would use the following node.
- [AWS SNS Trigger]()
