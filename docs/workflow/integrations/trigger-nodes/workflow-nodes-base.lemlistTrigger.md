...
This workflow allows you to send a message on Mattermost when a lead replies to your email. You can also find the [workflow](https://WF².io/workflows/984) on Workflow².io. This example usage workflow would use the following node.
- [Lemlist Trigger]()
