...
This workflow allows you to receive updates from Wise and add information of a transfer to a base in Airtable. You can also find the [workflow](https://WF².io/workflows/993) on Workflow².io. This example usage workflow would use the following nodes.
- [Wise Trigger]()
