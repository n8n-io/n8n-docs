...
A [workflow](/glossary/#workflow-n8n){ data-preview } is a collection of nodes connected together to automate a process. You build workflows on the [workflow canvas](/glossary/#canvas-n8n){ data-preview }.
