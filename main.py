...
def define_env(env):
	...
	LOCALES = {"bg":{"Й":"Y","Ц":"Ts","Щ":"Sht","Ъ":"A","Ь":"Y","й":"y","ц":"ts","щ":"sht","ъ":"a","ь":"y"},"de":{"Ä":"AE","ä":"ae","Ö":"OE","ö":"oe","Ü":"UE","ü":"ue","ß":"ss","%":"prozent","&":"und","|":"oder","∑":"summe","∞":"unendlich","♥":"liebe"},"es":{"%":"por ciento","&":"y","<":"menor que",">":"mayor que","|":"o","¢":"centavos","£":"libras","¤":"moneda","₣":"francos","∑":"suma","∞":"infinito","♥":"amor"},"fr":{"%":"pourcent","&":"et","<":"plus petit",">":"plus grand","|":"ou","¢":"centime","£":"livre","¤":"devise","₣":"franc","∑":"somme","∞":"infini","♥":"amour"},"pt":{"%":"porcento","&":"e","<":"menor",">":"maior","|":"ou","¢":"centavo","∑":"soma","£":"libra","∞":"infinito","♥":"amor"},"uk":{"И":"Y","и":"y","Й":"Y","й":"y","Ц":"Ts","ц":"ts","Х":"Kh","х":"kh","Щ":"Shch","щ":"shch","Г":"H","г":"h"},"vi":{"Đ":"D","đ":"d"},"da":{"Ø":"OE","ø":"oe","Å":"AA","å":"aa","%":"procent","&":"og","|":"eller","$":"dollar","<":"mindre end",">":"større end"},"nb":{"&":"og","Å":"AA","Æ":"AE","Ø":"OE","å":"aa","æ":"ae","ø":"oe"},"it":{"&":"e"},"nl":{"&":"en"},"sv":{"&":"och","Å":"AA","Ä":"AE","Ö":"OE","å":"aa","ä":"ae","ö":"oe"}}

	def custom_slugify(string, replacement='-', remove=None, lower=False, strict=False, locale=None, trim=True):
		if not isinstance(string, str):
			raise ValueError("slugify: string argument expected")
		locale_map = LOCALES.get(locale, {})
		slug = []
		
		for ch in unicodedata.normalize('NFKD', string):
			append_char = locale_map.get(ch) or CHAR_MAP.get(ch) or ch
			if append_char == replacement:
				append_char = ' '
			slug.append(append_char)
			
		slug = ''.join(slug)
		
		if remove:
			slug = re.sub(remove, '', slug)
		else:
		...
		def get_workflow_details(workflow: dict) -> Optional[dict]:
			try:
				return {
					...
					"url": f'https://n8n.io/workflows/{workflow["id"]}-{custom_slugify(workflow["name"], lower=True, strict=True)}/',
				}
			except KeyError:
				return None
	...
	def workflowDemo(workflow_endpoint):
		...
		wf_data = r.json()
		template_url = f'https://n8n.io/workflows/{wf_data["id"]}-{wf_data[""]}/'
		workflow_json = {
